...
vendor_chart "flux-operator" "0.38.1" "oci://ghcr.io/controlplaneio-fluxcd/charts" "core"
vendor_chart "prometheus-operator-crds" "26.0.0" "https://prometheus-community.github.io/helm-charts" "crds"
vendor_chart "cert-manager" "v1.19.2" "https://charts.jetstack.io" "crds"
vendor_chart "coredns" "1.45.0" "https://coredns.github.io/helm" "system"
vendor_chart "metrics-server" "3.13.0" "https://kubernetes-sigs.github.io/metrics-server/" "system"
vendor_chart "cert-manager" "v1.19.2" "https://charts.jetstack.io" "security"
vendor_chart "ingress-nginx" "4.14.1" "https://kubernetes.github.io/ingress-nginx" "ingress"
vendor_chart "victoria-metrics-operator" "0.57.1" "https://victoriametrics.github.io/helm-charts" "observability"
