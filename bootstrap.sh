...
# Cluster: skulikov-mega-cluster-4
# Repository: git@github.com:Lab-Brat/k8s-dev.git
# ============================================================================
...
CLUSTER_NAME="skulikov-mega-cluster-4"
REPO_URL="git@github.com:Lab-Brat/k8s-dev.git"
BRANCH="main"
FLUX_NS="flux-system"
...
gitRepository:
  name: flux-system
  url: git@github.com:Lab-Brat/k8s-dev.git
  branch: main
  interval: 1m
gitCredentials:
  enabled: true
